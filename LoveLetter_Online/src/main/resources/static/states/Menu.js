...
LoveLetterOnline.Menu.prototype = {
	...
	goTo: function(estado){
		this.state.start(estado);
	},
	...
	create: function(){
		...
		text1.events.onInputDown.add(function(){this.goTo('Lobby')}, this);//Jugar
		text2.inputEnabled = true;
		text2.events.onInputDown.add(function(){this.goTo('Ranking')}, this);
		text3.inputEnabled = true;
		text3.events.onInputDown.add(function(){this.goTo('Login')}, this);
